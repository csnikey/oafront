    ...
    <div class="block m-addplan">
      ...
      <el-form ref="form" label-width="120px">
        ...
        <div class="el-formli-self">
          ...
          <el-select v-model="form.term" placeholder="请选择学年">
            <el-option v-for="item in allterms" :key="item.id" :label="item.year" :value="item.id">
            </el-option>
          </el-select>
  
          <el-select v-model="form.targetweek" placeholder="弘文周">
        ...
        <div class="el-formli-self">
          ...
          <el-table :data="yearData">
            <el-table-column prop="date" label="个人收款额（元）" width="180">
            </el-table-column>
            <el-table-column prop="name" label="个人销售额（元）" width="180">
            </el-table-column>
            <el-table-column prop="address" label="个人操作项目数">
            </el-table-column>
            <el-table-column prop="address" label="团队收款额（元）">
            </el-table-column>
            <el-table-column prop="address" label="团队销售额（元）">
            </el-table-column>
            <el-table-column prop="address" label="团队操作项目数">
            </el-table-column>
          </el-table>
        </div>
        <div class="el-formli-self">
          ...
          <el-table :data="yearData">
            ...
            <el-table-column prop="name" label="本周个人目标">
            </el-table-column>
            <el-table-column prop="address" label="本周个人实际完成情况">
            </el-table-column>
            <el-table-column prop="address" label="本周个人完成比">
            </el-table-column>
            <el-table-column prop="address" label="本周团队目标">
            </el-table-column>
            <el-table-column prop="address" label="本周团队实际完成情况">
            </el-table-column>
            <el-table-column prop="address" label="本周团队完成比">
            </el-table-column>
          </el-table>
        </div>
...
export default {
  ...
  methods: {
    getterms(){
       this.$api.getTerms().then(
        res => {
         if(res.error==0){
           this.allterms= res.data.list
         }
        })
    },
      getNowstr(){
