<template>
  ...
  <el-form :inline="true"  class="demo-form-inline">
    ...
    <el-form-item label="请假类型">
      <el-select v-model="form.depart" placeholder="请假类型">
        <el-option label="类型1一" value="shanghai"></el-option>
...
<!--表格数据-->
  ...
  <el-table ref="multipleTable" :data="tableData3" border tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
    ...
    <el-table-column prop="realname" label="请假类型" width="120">
    </el-table-column>
    <el-table-column prop="address" label="请假天数" show-overflow-tooltip>
    </el-table-column>
